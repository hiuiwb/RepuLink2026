...
# -*- coding: utf-8 -*-
"""
Parameter sensitivity for PowerTrust's hybrid weighting on Bitcoin-OTC.
Raw scores come from the corrected file
    layer_1_2_analysis/bitcoin_otc/scores/powertrust_hybrid_corrected.csv
"""
...
def main():
    print("Loading corrected raw PowerTrust scores...")
    raw = load_corrected_baseline_score("powertrust_hybrid_corrected.csv",
                                        "powertrust_score")
