...
# -*- coding: utf-8 -*-
"""
Parameter sensitivity for AbsoluteTrust's hybrid weighting on Bitcoin-OTC.
Raw scores come from the corrected file
    layer_1_2_analysis/bitcoin_otc/scores/absolutetrust_hybrid_corrected.csv
"""
...
def main():
    print("Loading corrected raw AbsoluteTrust scores...")
    raw = load_corrected_baseline_score("absolutetrust_hybrid_corrected.csv",
                                        "absolutetrust_score")
