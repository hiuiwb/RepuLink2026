...
# -*- coding: utf-8 -*-
"""
Parameter sensitivity for PageRank's hybrid weighting on Bitcoin-OTC.

Raw scores come from the corrected scores file
    layer_1_2_analysis/bitcoin_otc/scores/pagerank_hybrid_corrected.csv
The sweep is
...
def main():
    print("Loading corrected raw PageRank scores...")
    raw = load_corrected_baseline_score("pagerank_hybrid_corrected.csv",
                                        "pagerank_score")
