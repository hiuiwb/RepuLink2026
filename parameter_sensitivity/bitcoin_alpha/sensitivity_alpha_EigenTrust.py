...
# -*- coding: utf-8 -*-
"""
Parameter sensitivity for EigenTrust's hybrid weighting on Bitcoin-Alpha.
Raw scores come from the pre-computed raw scores file
    layer_1_2_analysis/bitcoin_alpha/scores/eigentrust_hybrid.csv
"""
...
def main():
    print("Loading raw EigenTrust scores...")
    raw = load_corrected_baseline_score("eigentrust_hybrid.csv",
                                        "eigentrust_score")
