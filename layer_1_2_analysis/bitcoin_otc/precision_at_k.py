...
def plot_metric_at_k(metric_dict, ks, metric_name="Precision@K", title="Bitcoin OTC", output_file="precision_at_k.pdf"):
    ...
    plt.xlabel("Top-K", fontsize=30, fontproperties=bold_font)
    plt.ylabel(metric_name, fontsize=30, fontproperties=bold_font)
    plt.title(title, fontproperties=bold_font, fontsize=30)
    plt.xticks(ks, fontproperties=bold_font, fontsize=25)
...
def main():
    ...
    high_file = "scores/groundtruth_high.csv"
    low_file = "scores/groundtruth_low.csv"
    ...
    score_files = {
        ...
        "RepuLink": ("scores/repulink_hybrid_corrected.csv", "repulink_score")
    }
