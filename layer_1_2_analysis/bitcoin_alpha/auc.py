...
def main():
    ...
    ticks_font.set_weight('bold')
    ticks_font.set_size(25)
    label_font = FontProperties()
    label_font.set_weight('bold')
    label_font.set_size(30)
    plt.plot([0, 1], [0, 1], 'k--', label="Random")
    plt.xlabel("False Positive Rate", fontproperties=label_font)
    plt.ylabel("True Positive Rate", fontproperties=label_font)
    plt.xticks(fontproperties=ticks_font)
    plt.yticks(fontproperties=ticks_font)
    plt.title("Bitcoin Alpha", fontproperties=label_font)
